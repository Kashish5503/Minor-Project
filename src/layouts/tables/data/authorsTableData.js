    ...
    rows: [
      {
        ...
        function: <Job title="50 ADGIPS Tokens" description="" />,
        status: (
          <MDBox ml={-1}>
      ...
      },
      {
        ...
        function: <Job title="70 ADGIPS Tokens" description="" />,
        status: (
          <MDBox ml={-1}>
            <MDBadge badgeContent="Available" color="success" variant="gradient" size="sm" />
          </MDBox>
      ...
      },
      {
        ...
        function: <Job title="100 ADGIPS Tokens" description="" />,
        status: (
          <MDBox ml={-1}>
            <MDBadge badgeContent="Available" color="success" variant="gradient" size="sm" />
          </MDBox>
      ...
      },
      {
        ...
        function: <Job title="40 ADGIPS Tokens" description="" />,
        status: (
          <MDBox ml={-1}>
            <MDBadge badgeContent="Available" color="success" variant="gradient" size="sm" />
          </MDBox>
