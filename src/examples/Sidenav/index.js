...
import ADGIPSicon from "assets/images/icons/icon.png"
...
function Sidenav({ color, brand, brandName, routes, ...rest }) {
  ...
  if (wallet === "tz1PZmgQj6fmaucqpavsvoZEjyagmJqbumyn") {
    flag = true;
  }
    ...
    >
      <MDBox pt={3} pb={1} px={4} textAlign="center">
        ...
        <MDBox display="flex" alignItems="center">
          {brand && <MDBox component="img" src={ADGIPSicon} alt="Brand" width="2rem" />}
          <MDBox
            width={!brandName && "100%"}
